...
const LoginPortal = lazyWithRetry(() => import('./components/LoginPortal'), 'LoginPortal');
const SuperAdminPortal = lazyWithRetry(() => import('./components/SuperAdminPortal'), 'SuperAdminPortal');
const DailyCommandCenter = lazyWithRetry(() => import('./components/DailyCommandCenter'), 'DailyCommandCenter');
const LaunchCenter = lazyWithRetry(() => import('./components/LaunchCenter'), 'LaunchCenter');
const AIBusinessDepartment = lazyWithRetry(() => import('./components/AIBusinessDepartment'), 'AIBusinessDepartment');
const AdStudio = lazyWithRetry(() => import('./components/AdStudio'), 'AdStudio');
const EmailStudio = lazyWithRetry(() => import('./components/EmailStudio'), 'EmailStudio');
const CampaignPlanner = lazyWithRetry(() => import('./components/CampaignPlanner'), 'CampaignPlanner');
const SocialStudio = lazyWithRetry(() => import('./components/SocialStudio'), 'SocialStudio');
const RevenueIntelligenceOS = lazyWithRetry(() => import('./components/RevenueIntelligenceOS'), 'RevenueIntelligenceOS');
const SuccessCenter = lazyWithRetry(() => import('./components/SuccessCenter'), 'SuccessCenter');
const TenantWhiteLabelCenter = lazyWithRetry(() => import('./components/TenantWhiteLabelCenter'), 'TenantWhiteLabelCenter');
const CustomDomainCenter = lazyWithRetry(() => import('./components/CustomDomainCenter'), 'CustomDomainCenter');
const SubscriptionManagement = lazyWithRetry(() => import('./components/SubscriptionManagement'), 'SubscriptionManagement');
const TenantHealthMonitor = lazyWithRetry(() => import('./components/TenantHealthMonitor'), 'TenantHealthMonitor');
const RestaurantManagement = lazyWithRetry(() => import('./components/RestaurantManagement'), 'RestaurantManagement');
const MobileTableQrOrderingApp = lazyWithRetry(() => import('./components/MobileTableQrOrderingApp'), 'MobileTableQrOrderingApp');
const HotelManagement = lazyWithRetry(() => import('./components/HotelManagement'), 'HotelManagement');
const ToursAndTravelsManagement = lazyWithRetry(() => import('./components/ToursAndTravelsManagement'), 'ToursAndTravelsManagement');
const WebsiteBuilderOS = lazyWithRetry(() => import('./components/WebsiteBuilderOS'), 'WebsiteBuilderOS');
const BusinessOperations = lazyWithRetry(() => import('./components/BusinessOperations'), 'BusinessOperations');
const WorkflowAutomationStudio = lazyWithRetry(() => import('./components/WorkflowAutomationStudio'), 'WorkflowAutomationStudio');
const ApiGatewayDeveloperPortal = lazyWithRetry(() => import('./components/ApiGatewayDeveloperPortal'), 'ApiGatewayDeveloperPortal');
const AdvancedWebhookEngine = lazyWithRetry(() => import('./components/AdvancedWebhookEngine'), 'AdvancedWebhookEngine');
const IntegrationManager = lazyWithRetry(() => import('./components/IntegrationManager'), 'IntegrationManager');
const AiTelemetryModal = lazyWithRetry(() => import('./components/AiTelemetryModal'), 'AiTelemetryModal');
const PaymentSuccessModal = lazyWithRetry(() => import('./components/PaymentSuccessModal'), 'PaymentSuccessModal');
const FirstVisitSecurityModal = lazyWithRetry(() => import('./components/FirstVisitSecurityModal'), 'FirstVisitSecurityModal');
